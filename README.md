...
- **Faturamento total**
  ![Grafico faturamento](Faturamento_Total_por_Loja.png)
- **Satisfação do cliente** (avaliação média)
  ![Grafico Média](Média_de_Avaliação_dos_Clientes_por_Loja.png)
- **Eficiência operacional** (custo do frete como percentual do faturamento)
  ![Grafico Score](Score_Total_de_Desempenho_por_Loja.png)
